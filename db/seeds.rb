...
snowshow = Mountain.create(name: 'Snowshow', city: 'Snowshoe', state: 'WV', trailmap: 'https://www.snowshoemtn.com/-/media/Snowshoe/Maps/pdf/SN_18_Winter_Trailmap_Web.pdf', url: 'https://www.snowshoemtn.com/', user_id: 1, region_id: 1)
